...
Он отличен от library-owned cabinet templates, но при этом работает вместе с cabinet-layer, когда тот установлен.
...
- service-worker support добавляет manifest и `sw.js` assets в project output
